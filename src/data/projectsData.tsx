...
const projectsData = [
  {
    title: "OTT Wars",
    description:
      "A web app (ongoing project) to pick your favourite movie and test your knowledge by answering questions.",
    media: netflixDemo,
    demoURL: "https://ott-wars.vercel.app/",
  ...
  },
  {
    title: "GitHub Finder",
    description:
      "A web app integrated with GitHub API to search users via their usernames.",
  ...
  
  {
    ...
    description:
      "A video compilation of AR/VR Projects and prototypes that I have worked on till date.",
    media: arvrDemo,
  ...
  },
  {
    ...
    description:
      "A video compilation of 3D Models and animations that I designed with Blender.",
  ...
  },
  {
    ...
    articleURL: "",
    type: "project",
    skillTags: ["Three.js", "JavaScript", "DAT GUI", "HTML", "CSS"],
  },
  {
    title: "9 Must Have Skills To Become An AR/VR Developer",
    description:
      'This article of mine is published in HackerNoon and more than 25000+ reads. It also shows up on the first page of Google if you search for "ar/vr skills".',
  ...
  },
  {
    ...
    description:
      "In this article (published in LogRocket), you will learn how to create an augmented reality experience using Vuforia and Unity. You will also learn how to test and run your app on an Android smartphone.",
  ...
  },
  {
    ...
    description:
      "In this article (published in LogRocket), I will show you how to create a 360 VR video in Unity with the help of two tools- Unity Recorder & Google Spatial Media Metadata Injector",
  ...
  },
  {
    ...
    description:
      "I earned a fully sponsored trip to attend Google I/O 2019 conference at Mountain View, California.",
    media: googleTripArticle,
    demoURL: "",
    codeURL: "",
    articleURL:
      "https://medium.com/@knightcube/google-i-o-2019-experience-cf0692aacb9d",
    type: "article",
    skillTags: [],
  },
];
