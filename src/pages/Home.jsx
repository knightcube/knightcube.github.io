...
export default function Home() {
  ...
  return (
    <main className="flex-grow pt-32 pb-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full z-10 relative">
      ...
      <section className="flex flex-col items-start mb-32 md:mb-48 reveal-on-scroll mt-10">
        ...
        <h1 className="font-display text-[40px] md:text-[56px] lg:text-[84px] text-on-surface mb-8 leading-[1.05] tracking-tight max-w-4xl">
          Building robust systems &<br />
          <span className="text-primary-container text-glow">beautiful interfaces.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <Link to="/software" className="group inline-flex items-center justify-center px-8 py-4 bg-primary-container text-black font-label-md uppercase tracking-wider hover:bg-surface-tint transition-all duration-300 rounded-sm">
            View My Work
          ...
          <Link to="/contact" className="inline-flex items-center justify-center px-8 py-4 border border-outline-variant text-on-surface font-label-md uppercase tracking-wider hover:border-primary-container hover:text-primary-container transition-all duration-300 rounded-sm">
            Get in Touch
          </Link>
        </div>
      </section>
